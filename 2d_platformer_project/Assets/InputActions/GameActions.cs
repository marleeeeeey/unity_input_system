...
//     version 1.7.0
//     from Assets/InputActions/GameActions.inputactions
//
...
public partial class @GameActions: IInputActionCollection2, IDisposable
{
    ...
    public struct PlayerNormalActions
    {
        ...
        public PlayerNormalActions(@GameActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @GameActions m_Wrapper;
        public PlayerUnderwaterActions(@GameActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @GameActions m_Wrapper;
        public PlayerInCarActions(@GameActions wrapper) { m_Wrapper = wrapper; }
